...
# ======= PARAMETERS =======
BASE_DIR="/upb/users/j/joeldag/profiles/unix/cs/results_language_adapters/mistral7b/niger_congo"
TOKENIZER_NAME="/upb/users/j/joeldag/profiles/unix/cs/results_language_adapters/mistral7b/niger_congo/adapter"
...
BATCH_SIZE="128"
LIMIT="150"
WANDB_PROJECT="mistral7b_niger_congo_adapter_evaluation"
