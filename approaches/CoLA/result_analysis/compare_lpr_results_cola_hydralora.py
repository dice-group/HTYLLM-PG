...
METRIC_ALIASES: Dict[str, List[str]] = {
    ...
    "train/cola/active_expert_frac": [
        "train/cola/active_expert_frac",
        "train/train/cola/active_expert_frac",
        "cola/active_expert_frac",
        "_router_metrics/cola/active_expert_frac",
    ],
    "train/cola/expert_load_cv": [
        "train/cola/expert_load_cv",
        "train/train/cola/expert_load_cv",
        "cola/expert_load_cv",
        "_router_metrics/cola/expert_load_cv",
    ],
    "train/cola/router_entropy": [
        "train/cola/router_entropy",
        "train/train/cola/router_entropy",
        "cola/router_entropy",
        "_router_metrics/cola/router_entropy",
    ],
    "train/cola/topk_weight_mean": [
        "train/cola/topk_weight_mean",
        "train/train/cola/topk_weight_mean",
        "cola/topk_weight_mean",
        "_router_metrics/cola/topk_weight_mean",
    ],
    "train/cola/language_target_hit_rate": [
        "train/cola/language_target_hit_rate",
        "train/train/cola/language_target_hit_rate",
        "cola/language_target_hit_rate",
        "_router_metrics/cola/language_target_hit_rate",
    ],
    "train/cola/language_target_prob_mean": [
        "train/cola/language_target_prob_mean",
        "train/train/cola/language_target_prob_mean",
        "cola/language_target_prob_mean",
        "_router_metrics/cola/language_target_prob_mean",
    ],
    "train/cola/language_target_token_frac": [
        "train/cola/language_target_token_frac",
        "train/train/cola/language_target_token_frac",
        "cola/language_target_token_frac",
        "_router_metrics/cola/language_target_token_frac",
    ],
    "train/hydralora/head_load_cv": [
        "train/hydralora/head_load_cv",
        "train/train/hydralora/head_load_cv",
        "hydralora/head_load_cv",
        "_router_metrics/hydralora/head_load_cv",
    ],
    "train/hydralora/head_active_frac": [
        "train/hydralora/head_active_frac",
        "train/train/hydralora/head_active_frac",
        "hydralora/head_active_frac",
        "_router_metrics/hydralora/head_active_frac",
    ],
    "train/hydralora/head_router_entropy": [
        "train/hydralora/head_router_entropy",
        "train/train/hydralora/head_router_entropy",
        "hydralora/head_router_entropy",
        "_router_metrics/hydralora/head_router_entropy",
    ],
    "train/hydralora/head_target_hit_rate": [
        "train/hydralora/head_target_hit_rate",
        "train/train/hydralora/head_target_hit_rate",
        "hydralora/head_target_hit_rate",
        "_router_metrics/hydralora/head_target_hit_rate",
    ],
    "train/hydralora/head_target_prob_mean": [
        "train/hydralora/head_target_prob_mean",
        "train/train/hydralora/head_target_prob_mean",
        "hydralora/head_target_prob_mean",
        "_router_metrics/hydralora/head_target_prob_mean",
    ],
    "train/hydralora/head_target_token_frac": [
        "train/hydralora/head_target_token_frac",
        "train/train/hydralora/head_target_token_frac",
        "hydralora/head_target_token_frac",
        "_router_metrics/hydralora/head_target_token_frac",
    ],
    "train/hydralora/expert_load_cv": [
        "train/hydralora/expert_load_cv",
        "train/train/hydralora/expert_load_cv",
        "hydralora/expert_load_cv",
        "_router_metrics/hydralora/expert_load_cv",
    ],
    "train/hydralora/expert_active_frac": [
        "train/hydralora/expert_active_frac",
        "train/train/hydralora/expert_active_frac",
        "hydralora/expert_active_frac",
        "_router_metrics/hydralora/expert_active_frac",
    ],
    "train/hydralora/expert_router_entropy": [
        "train/hydralora/expert_router_entropy",
        "train/train/hydralora/expert_router_entropy",
        "hydralora/expert_router_entropy",
        "_router_metrics/hydralora/expert_router_entropy",
    ],
    "train/hydralora/expert_topk_weight_mean": [
        "train/hydralora/expert_topk_weight_mean",
        "train/train/hydralora/expert_topk_weight_mean",
        "hydralora/expert_topk_weight_mean",
        "_router_metrics/hydralora/expert_topk_weight_mean",
    ],
    "train/hydralora/expert_target_hit_rate": [
        "train/hydralora/expert_target_hit_rate",
        "train/train/hydralora/expert_target_hit_rate",
        "hydralora/expert_target_hit_rate",
        "_router_metrics/hydralora/expert_target_hit_rate",
    ],
    "train/hydralora/expert_target_prob_mean": [
        "train/hydralora/expert_target_prob_mean",
        "train/train/hydralora/expert_target_prob_mean",
        "hydralora/expert_target_prob_mean",
        "_router_metrics/hydralora/expert_target_prob_mean",
    ],
    "train/hydralora/expert_target_token_frac": [
        "train/hydralora/expert_target_token_frac",
        "train/train/hydralora/expert_target_token_frac",
        "hydralora/expert_target_token_frac",
        "_router_metrics/hydralora/expert_target_token_frac",
    ],
}
