...
bash "tokenize_all_tokenizers_lang_combinations.sh" \
  --shard-dir /scratch/hpc-prf-merlin/project_data/moe_study/adapter_dataset/inital_samples_datatrove/samples \
  --output-base /scratch/hpc-prf-merlin/project_data/moe_study/adapter_dataset/tokenized \
