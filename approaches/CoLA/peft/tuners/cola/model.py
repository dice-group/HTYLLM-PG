...
from .layer import Conv2d, ColaLayer, dispatch_default
...
class ColaModel(BaseTuner):
    ...
    Example:
        ...
        >>> lora_model = ColaModel(model, config, "default")
        ```

        ```py
        >>> import torch
        >>> import transformers
        >>> from peft import ColaConfig, PeftModel, get_peft_model, prepare_model_for_kbit_training
    ...
    **Attributes**:
        ...
        - **peft_config** ([`ColaConfig`]): The configuration of the Lora model.
    """
    ...
    def _check_new_adapter_config(self, config: ColaConfig) -> None:
        """
    ...
    def _prepare_model(self, peft_config: ColaConfig, model: nn.Module):
        r"""
