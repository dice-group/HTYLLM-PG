...
TOKENIZED_DIR="/upb/users/j/joeldag/profiles/unix/cs/tokenized_data_subsets/gemma3-4b-pt/tso_Latn_ssw_Latn/"
TOKENIZER_PATH="google/gemma-3-4b-pt"
MODEL_NAME="google/gemma-3-4b-pt"
OUTPUT_DIR="/upb/users/j/joeldag/profiles/unix/cs/results_language_adapters/gemma3-4b-pt/tso_Latn_ssw_Latn"
LOGGING_DIR="/upb/users/j/joeldag/profiles/unix/cs/results_language_adapters/gemma3-4b-pt/tso_Latn_ssw_Latn/logs"
mkdir -p "$LOGGING_DIR"
