...
def parse_arguments():
    ...
    parser.add_argument('--total_docs', type=int, default=10_000,
                        help='Total number of documents to sample across all languages')
    
    parser.add_argument('--num_languages', type=int, default=500,
                        help='Number of languages to include in the sampling')
    
    parser.add_argument('--output_dir', type=str, default='./fineweb2_subset',
                        help='Directory to store the sampled data')
    
    parser.add_argument('--stats_file', type=str, default=None,
                        help='File to store sampling statistics (default: sampling_stats.json in output_dir)')
    
    parser.add_argument('--meta_file', type=str, default='./sampler/fineweb2_meta.json',
                        help='Path to the fineweb2 metadata file containing document counts')
    
    parser.add_argument('--include_english', action='store_true',
                        help='Include English data from fineweb dataset with remaining budget')
